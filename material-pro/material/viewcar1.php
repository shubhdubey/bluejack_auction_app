...
$sql_car = "SELECT * FROM carmaster where id='$id'";
$res_car=mysqli_query($conn,$sql_car);
$row_car=mysqli_fetch_assoc($res_car);
$carmake_id=$row_car['brandname'];
$sql_brand="SELECT * FROM carmake WHERE id='$carmake_id'";
$res_brand=mysqli_query($conn,$sql_brand);
$row_brand=mysqli_fetch_assoc($res_brand);
$model_id=$row_car['carmake'];
$brandname = $row_brand['carmake'];
$sql_model="SELECT * FROM carmodel WHERE id='$model_id'";
$res_model=mysqli_query($conn,$sql_model);
$row_model=mysqli_fetch_assoc($res_model);
$modelname= $row_model['carmodel'];
$variant_id=$row_car['carmodel'];
// $row_model['carmodel'];
$sql_variant="SELECT * FROM carvariant WHERE id='$variant_id'";
$res_variant=mysqli_query($conn,$sql_variant);
$row_variant=mysqli_fetch_assoc($res_variant);
$variantname= $row_variant['carvariant'];
...
<head>
    ...
    <title>Bluejack | Car Detail</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="in">
                        ...
                        <li class=""> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Car Detail</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item "><a href="javascript:void(0)">Cars</a></li>
                            <li class="breadcrumb-item active"><?php echo ucwords($brandname)." - ".ucwords($modelname)?></li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-body">
                                <div id="carouselCar" class="carousel slide" data-ride="carousel">
                                    ...
                                    <a class="carousel-control-prev" href="#carouselCar" role="button" data-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="sr-only">Previous</span> </a>
                                    <a class="carousel-control-next" href="#carouselCar" role="button" data-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="sr-only">Next</span> </a>
                                </div>
                        ...
                        <div class="row">
                            <div class="card col-md-5">
                                        <div class="card-body">
                                            <h4 class="card-title">Car Details  <button style="float:right;" type="button" id="addButton" class="btn btn-outline-success" style="float:right; margin-right:2em;display:block;"><i class="mdi mdi-library-plus" ></i> Add images</button></h4>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="" id="addImages" class="form-material m-t-40">
                                                    <div class="form-group">
                                                        <input type="file" name= 'file[]' multiple='' class="form-control" id="file" aria-describedby="fileHelp">
                                                    </div>

                                                    <div>
                                                        <button type="button" id="closeButton" class="btn btn-default waves-effect closeModal" data-dismiss="modal">Close</button>
                                                        <button type="submit" name="submit" id="saveButton" class="btn btn-danger waves-effect waves-light upload">Save</button>
                                                    </div>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $i=0;
                                                            $j=0;
                                                            while($i<mysqli_num_fields($res_car)){
                                                                
                                                                
                                                                $cols=mysqli_fetch_field($res_car);
                                                                $field = $cols->name;
                                                                if(1){
                                                                if($i==1){
                                                                    echo '<tr><td>BRAND</td>';
                                                                    echo '<td>'.strtoupper($brandname).'</td></tr>';
                                                                }

                                                                else if($i==2){
                                                                    echo '<tr><td>MODEL</td>';
                                                                    echo '<td>'.strtoupper($modelname).'</td></tr>';
                                                                }
                                                                else if($i==3){
                                                                    echo '<tr><td>VARIANT</td>';
                                                                    echo '<td>'.strtoupper($variantname).'</td></tr>';
                                                                }
                                                                else if($i==5){
                                                                    echo '<tr><td>MODEL YEAR</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';
                                                                }
                                                                else if($i==6){
                                                                    ...
                                                                    echo '<tr><td>REG STATE</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';
                                                                }
                                                                else if($i==8){
                                                                    echo '<tr><td>DEMAND PRICE</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';
                                                                }
                                                                else if($i==9){
                                                                    echo '<tr><td>BID START PRICE</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';
                                                                }
                                                                
                                                                else if($i==14){
                                                                    echo '<tr><td>ENGINE</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';
                                                                }
                                                                else if($i==25){
                                                                    echo '<tr><td>TEST DRIVE RESULT</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';
                                                                }
                                                                else if($i==27){
                                                                    echo '<tr><td>WIND SHIELD</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';
                                                                }
                                                                else if($i==28){
                                                                    echo '<tr><td>WORK DONE ON CAR</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';
                                                                }
                                                                    ...
                                                                    echo '<tr>';
                                                                    echo '<td>'.strtoupper($cols->name).'</td>';
                                                                    echo '<td>'.$row_car["$field"].'</td></tr>';}
                                                                    $i=$i+1;
                                                                }
                                                                }

                                                            /*while ($row = mysqli_fetch_row($res_car)) 
                                                                {
                                                                    $count = count($row);
                                                                    $y = 0;
                                                                    while ($y < $count)
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql_bid="SELECT * from bidmaster where carid='$carid'";
                                                        $res_bid=mysqli_query($conn,$sql_bid);
                                                        while($row=mysqli_fetch_array($res_bid)){
                                                                echo "<tr><td>";
                                                                $dealer=$row['dealerid'];
                                                                $sql_deal="SELECT dname from dealermaster where id='$dealer'";
                                                                $run_deal=mysqli_query($conn,$sql_deal);
                                                                $res_deal=mysqli_fetch_assoc($run_deal);
                                                                echo $res_deal['dname']."</td>";
