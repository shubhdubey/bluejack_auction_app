    ...
    <div id="main-wrapper">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="in">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-book-open"></i><span class="hide-menu">Reports</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="report_cars.php">Inspection</a></li>
        ...
        <div class = "row">
                 ...
                 <!-- Column -->
                        ...
                        <div class="card card-inverse card-success" >
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h3 class="card-title">Active Bids</h3> </div>
                                </div>
                                <div class="row">
                    ...
                    <!-- Column -->
                    <div class="col-lg-4 col-md-4" >
                        <div class="card customcards" id="dealer">
                            <img class="" src="../assets/images/background/weatherbg.jpg" alt="Card image cap">
                            <div class="card-img-overlay">
                                <h2 class="card-title text-white m-b-0 dl"><i class ="mdi mdi-account-check"></i>&nbsp; Dealers</h2>
                              </div>
                            <div class="card-body weather-small">
                                <div class="row">
                                    <div class="col-8 b-r align-self-center">
                                        <div class="d-flex">
                                            <div class="display-6 text-info"><i class="mdi mdi-asterisk"></i></div>
                                            <div class="m-l-20">
                                                <h4 class="font-light text-info m-b-0">85</h4>
                                                <small>Total</small>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-4 text-center">
                                        <h4 class="font-light m-b-0">25</h4> 
                                        <small>Monthly</small>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!--Cloumn -->
                    <div class="col-lg-4 col-md-4">
                        <div class="card card-inverse card-primary customcards">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="m-r-20 align-self-center">
                                        <h1 class="text-white"><i class="mdi mdi-car"></i></h1></div>
                                    <div>
                                        <h3 class="card-title">Cars</h3></div>
                                </div>
                                <div class="row">
                                    <div class="col-4 align-self-center">
                                        <h2 class="font-light text-white">50</h2>
                                        <h5 class ="font-light text-white">NEW </h5>
                                    </div>
