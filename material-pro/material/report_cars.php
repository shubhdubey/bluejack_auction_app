...
<head>
    ...
    <title>Bluejack | Car Reporta</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-material">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                                    <label>Brand</label>
                                                    <select name="brandSelect" class="form-control custom-select">
                            ...
                            <div class="col-md-6">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" placeholder="2018-05-01" id="mdate" >
                                </div>
                            </div>
                        </div>
                        <div class="row">
